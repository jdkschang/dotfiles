...
(def-doom-theme doom-Iosvkem
  ...
  ((bg         '("#1b1d1e" "#1b1d1e" nil            ))
   ...
   (base4      '("#505050" "#525252" "brightblack"  ))
   (base5      '("#505050" "#525252" "brightblack"  ))
   (base6      '("#808080" "#828282" "brightblack"  ))
   (base7      '("#808080" "#828282" "brightblack"  ))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ((outline-4 &override) :foreground (doom-lighten blue 0.25) :weight 'bold)
   ((outline-5 &override) :foreground (doom-lighten magenta 0.25) :weight 'bold)
   ((outline-6 &override) :foreground (doom-lighten dark-cyan 0.25) :weight 'bold)
   ((outline-7 &override) :foreground (doom-lighten blue 0.5) :weight 'bold)
   ((outline-8 &override) :foreground (doom-lighten magenta 0.5) :weight 'bold)
